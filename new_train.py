...
def train_part(model_G, model_D, loader_train, num_epochs=2):
    Disc_lr = 2e-4
    beta1 = 0.5
    Gene_lr = 1e-4
...
def main():
    ...
    train_losses_G, train_losses_D, content_loss, error_D = train_part(model_G, model_D, loader_train, num_epochs=1)
    plot_loss(train_losses_G, train_losses_D, content_loss, error_D)
